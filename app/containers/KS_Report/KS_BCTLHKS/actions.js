...
export function fetchMainTableData(formData) {
  return {
    type: constants.FETCH_MAIN_TABLE_REPORT_DATA,
    payload: formData,
  };
}

export function fetchMainTableDataSuccess(data) {
  return {
    type: constants.FETCH_MAIN_TABLE_REPORT_DATA_SUCCESS,
    payload: data,
  };
}
...
export function syncReportSuccess(payload) {
  return {
    type: constants.SYNC_DATA_SUCCESS,
    payload,
  };
}
