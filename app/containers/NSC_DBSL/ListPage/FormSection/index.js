...
export class FormSection extends React.Component {
   ...
   */
  makeFormAttr = pr => {
    const { formData, onGetProductAuto, onGetLSXAuto } = this.props;
      ...
      LSXCodeFrom: {
        ...
        loadOptions: (inputValue, callback) => {
          ...
          autoCompleteTimer1 = setTimeout(() => {
            ...
            onGetLSXAuto(inputValue, Farms, farmIdFrom, farmIdTo, callback);
          }, 200);
        },
      },
      LSXCodeTo: {
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    onGetLSXAuto: (inputText, Farms, fromFarm, toFarm, callback) =>
      dispatch(
        actions.getLSXAuto(inputText, Farms, fromFarm, toFarm, callback),
      ),
  };
}
