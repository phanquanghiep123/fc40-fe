...
export default class MTableBodyRowCustomized extends React.Component {
  renderColumns() {
  ...
  renderSelectionColumn() {
    return (
      <TableCell
        ...
        style={{ width: 48 + 12 * (this.props.treeDataMaxLevel - 1) }}
      >
        <Checkbox
      ...
      if (
        ...
        renderColumns.splice(
          ...
          <TableCell
            ...
            style={{ width: 48 + 12 * (this.props.treeDataMaxLevel - 2) }}
          >
            <IconButton
              style={{
                transition: 'all ease 200ms',
...
MTableBodyRowCustomized.defaultProps = {
  actions: [],
  index: 0,
  data: {},
  options: {},
...
MTableBodyRowCustomized.propTypes = {
