 ...
 * @param {object} tableTotal
 * @return {{org: *, rowData: *, type: string}}
 */
export function formSubmitSuccess(submittedValues, tableData, tableTotal) {
  return {
 ...
 * @return {{inputValue: *, type: string}}
 */
export function fetchPlan(inputValue, callback) {
  return {
    type: constants.FETCH_PLAN,
    inputValue,
    callback,
  };
}
